...
class Task {
    ...
    fun getID(): Long = task_id

    fun getDateCreated(): Calendar = date_create!!

    @Deprecated("")
    fun getDate_due(): Calendar = date_due!!

    fun getDateDue(): Calendar = date_due!!

    fun getDateDueString(): String =
            if (date_due == null) "No Date" else (date_due!!.get(Calendar.MONTH) + 1).toString() + "/" +
                date_due!!.get(Calendar.DAY_OF_MONTH).toString() + "/" +
                date_due!!.get(Calendar.YEAR).toString()

    fun getDateUpdated(): Calendar = date_updated!!

    fun getDateArchived(): Calendar = date_archived!!

    @Deprecated("")
    fun getDate_deleted(): Calendar = date_deleted!!

    fun getDateDeleted(): Calendar = date_deleted!!
    ...
    fun onTime(): Boolean = complete_on_time

    fun late(): Boolean = complete_late
