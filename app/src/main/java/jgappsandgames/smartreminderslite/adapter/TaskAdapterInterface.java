...
public abstract class TaskAdapterInterface extends BaseAdapter {
    ...
    // Initializers
    public TaskAdapterInterface(Activity activity, OnTaskChangedListener listener, ArrayList<Task> tasks) {
        this.activity = activity;
        this.listener = listener;
        this.tasks = tasks;
    }

    public TaskAdapterInterface(Activity activity, OnTaskChangedListener listener, ArrayList<String> tasks, String unused) {
        this.activity = activity;
        this.listener = listener;
