...
public class API {
    ...
    // Management (11/15/17)
    public static final int MANAGEMENT = 11;
    public static final String MANAGEMENT_INFO = "Managers Save, Universal Manager, Task Metadata, File Metadata, Change Listeners";
}